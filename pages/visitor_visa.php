...
<head>
    ...
    <meta name="description" content="Canada Visitor Visa - How can Fastway Immigration team can assist you visit Canada for tourism">
    <meta name="author" content="Fastway Immigration">
    <meta name="keywords" content="canada tourist visa, canada visitor visa, visit canada, visitor visa, tourism canada, fastway services, fastway visa, fastway immigration and visa services, fastwayim, sunil malhotra, sangeeta malhotra">
    <title>Canadian Visitor Visa | Fastway Immigration</title>
...
<body class="color-background-grey-light color-font-dark-grey font-type-sans-serif">
    ...
    <article>
        <div class="color-background-brand-tertiary-dark color-font-white shadow py-2">
            <div class="container">
                <!-- Page Heading -->
                <h1 class="font-size-1 font-type-serif py-1">Canada Tourist / Visitor Visa</h1>
            </div>
        </div>
        ...
        <div class="container py-3 text-justify">
            ...
            <ul class="font-size-4">
                <li>satisfy an officer that you will leave Canada at the end of your stay for reasons like family, employment, financial assets, home etc.</li>
                <li>show that you have enough money to maintain yourself and your family members in Canada and to return home</li>
                <li>not intend to work or study in Canada unless authorized to do so</li>
                <li>be law abiding and have no record of criminal activity</li>
                <li>not be a risk to the security of Canada</li>
                <li>provide any additional document requested by the officer to establish your admissibility, and</li>
            ...
            <h4 class="font-size-4 color-font-black"><strong>Applying for Visitor Visa</strong></h4>
            <p class="font-size-4 py-1">
            ...
            <h4 class="font-size-4 color-font-black"><strong>Single/Multiple Entry Visa</strong></h4>
            <p class="font-size-4 py-1">
            ...
            <h4 class="font-size-4 color-font-black"><strong>Application Processing under Tourist Visa</strong></h4>
            <p class="font-size-4 py-1">
            ...
            <ol class="font-size-4">
                <li><strong>Medical Exam : </strong>Sometimes applicants can be asked to provide medical exam results to gain entry into Canada.  In this situation, there are chances of delay as applicant will need to set appointments with penal physician, undergo medical examination and then doctor will take time to send in the required results to IRCC.</li>
                <li><strong>Police Clearance Certificate : </strong>The applicant can be asked to get police verification done and get a Police certificate for himself and any other family member, under or above the age of 18 years, who will be accompanying him or her to Canada.</li>
                <li><strong>Interview : </strong>Sometimes, Visa Officer can fix applicant’s interview for clearing his/her doubts though decision on most of the TRV Applications are taken without conducting interview.</li>
                <li><strong>Application Approved : </strong>If the application is approved, in the case of ONLINE applications, the applicant will be advised to submit Passport for sticking visa counterfoil. If paper application was submitted visa will get stamped inside the passport of applicant.</li>
                <li><strong>Application Refused : </strong>In the scenario wherein the application is refused, the applicant will be notified for same with the reason for refusal.</li>
            </ol>
    ...
    <div id="howCanWeHelpSection" class="py-3 text-justify color-background-brand-secondary">
        <div class="container">
            ...
            <p class="font-size-4">Though no one can promise any guarantees, but we are certain we can help you increase your chances of getting positive outcome with our experience. For any inquiry/initial assessment, please call/email us</p>
        </div>
    </div>
