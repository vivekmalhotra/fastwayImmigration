...
<head>
    ...
    <meta name="keywords" content="other services fastway immigration, miscellaneous services, fastway services, canada citizenship application, renewal of permanent residence card, overseas citizen of india, OCI card, OCI card issuance, renewal of canadian passport, sunil malhotra, sangeeta malhotra">
    ...
    <div class="container breadcrumbs">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pl-0 py-1 mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Miscellaneous Services</li>
            </ol>
        </nav>
    </div>
    <!-- Content of the page -->
    <article class="pb-5">
        <div class="color-background-brand-tertiary-dark color-font-white shadow py-2">
            <div class="container p-2">
                <!-- Page Heading -->
                <h1 class="font-size-1 font-type-serif py-1">Other services</h1>
            </div>
        </div>
        <!-- Add a bit of a text -->
        <div class="container py-3 text-justify">
            <!-- TODO Add some text on making the user choose appropriate case-->
            <p class="font-size-4 py-1 mb-0">
                Apart from regular immigration and Visa Services, we can help you in applying for:
            </p>
            <ul class="font-size-4 mb-1">
                ...
                <li>Surrender of Indian Passports</li>
                <li>Issue of OCI Cards</li>
                <li>Verification of Status</li>
                <li>Replacement of Immigration Document</li>
                <li>Changes to Record of Landing</li>
                <li>Changes to COPR</li>
                <li>Replacing a Temporary Resident document</li>
            </ul>
            <p class="font-size-4 py-1 mb-0">
                Please <a href="#contactUs" class="color-font-black"><strong>contact our team</strong></a> for any of your immigration needs.  We have provided some more detailed information about a few of these below:
            </p>
        </div>
                    ...
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body text-center d-flex flex-column justify-content-between pb-5">
                            ...
                            <ul class="text-left py-2">
                                <li>Meet Physical Presence requirements</li>
                                <li>Meet other eligibility requirements</li>
                                <li>Have Clean record</li>
                            </ul>
                            <a href="/pages/other_services/canadian_citizenship_application.php" class="btn button-service-card rounded-0">Read more</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body text-center d-flex flex-column justify-content-between pb-5">
                            ...
                            <ul class="text-left py-2">
                                <li>Apply for Renewal of PR Card</li>
                                <li>Can apply 270 days before expiration</li>
                            </ul>
                            <a href="/pages/other_services/canada_pr_card.php" class="btn button-service-card rounded-0">Read more</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body text-center d-flex flex-column justify-content-between pb-5">
                            ...
                            <ul class="text-left py-2">
                                <li>Person of Indian Origin</li>
                                <li>Became Canadian Citizen</li>
                                <li>Apply for OCI Card</li>
                                <li>No need for Indian Visa</li>
                            </ul>
                            <a href="/pages/other_services/overseas_citizen_of_india.php" class="btn button-service-card rounded-0">Read more</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col mb-4">
                    <div class="card h-100 shadow">
                        ...
                        <div class="card-body text-center d-flex flex-column justify-content-between pb-5">
                            ...
                            <ul class="text-left py-2">
                                <li>Renew Passport before expiry</li>
                                <li>Amendment in Passport</li>
                            </ul>
                            <a href="/pages/other_services/passport_application.php" class="btn button-service-card rounded-0">Read more</a>
                        </div>
                    </div>
                </div>
